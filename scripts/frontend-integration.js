 ...
 * This file demonstrates how to integrate Farmgaze with a web frontend
 */

// For React/Vue/Angular applications
export class FarmgazeClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new FarmgazeClient(provider, contractAddress);
